...
//#include "ntdll.h"
//
//https://ntquery.wordpress.com/2014/03/29/anti-debug-ntcreatethreadex/
//https://guidedhacking.com/threads/use-ntcreatethreadex-with-64-bit-processes.10798/
//https://docs.microsoft.com/en-gb/windows/desktop/api/libloaderapi/nf-libloaderapi-getprocaddress
//
...
{
    LPCSTR libName = "ntdll.dll";
    HMODULE lNtdll = LoadLibraryA(libName);
